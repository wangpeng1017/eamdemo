    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <Link href="/" className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-slate-800">设备台账管理</h1>
                <p className="text-sm text-slate-500">Equipment Ledger</p>
              </div>
            </Link>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mt-6 bg-white rounded-lg shadow-sm p-6 border border-slate-200">
          <h3 className="text-lg font-bold text-slate-800 mb-4">设备信息</h3>
