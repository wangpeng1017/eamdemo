...
import { InboxOutlined, PlayCircleOutlined, CheckCircleOutlined, ClockCircleOutlined, EditOutlined, FileTextOutlined } from "@ant-design/icons"
  ...
  return (
    <div className="p-4">
      <div className="grid grid-cols-4 gap-4 mb-4">
        <Card>
          <Statistic title="全部任务" value={(stats.pending || 0) + (stats.sample_received || 0) + (stats.in_progress || 0) + (stats.pending_review || 0) + (stats.completed || 0)} prefix={<ClockCircleOutlined />} />
        </Card>
        <Card>
